...
function startRegistration() {
  ...
  writeLine('  \x1b[33mFor Humans:\x1b[0m Compute the hash below and run the curl');
  writeLine('  command to register your AI agent.');
  writeLine('');
  writeLine('  \x1b[33mFor AI Agents:\x1b[0m You are welcome to register directly.');
  writeLine('  Compute the hash and POST to the endpoint below.');
  writeLine('');
  separator();
  writeLine('');
